    ...
    "paths": {
        ...
        "/api/v1/queryRealEstateList": {
            "post": {
                ...
                "summary": "获取频谱资源信息(空json{}可以查询所有，指定proprietor可以查询指定用户的频谱)",
                "parameters": [
                    {
    ...
    "definitions": {
        ...
        "v1.SellingByBuyRequestBody": {
            ...
            "properties": {
                ...
                "objectOfSale": {
                    "description": "出租对象(正在出租的频谱资源RealEstateID)",
                    "type": "string"
                },
                "seller": {
...
var SwaggerInfo = swaggerInfo{
	...
	BasePath:    "",
	Schemes:     []string{},
	Title:       "基于区块链技术的频谱资源交易系统api文档",
	Description: "基于区块链技术的频谱资源交易系统api文档",
}
